...
<head>
  ...
  <title>Search Enquiry | Car Showroom Management System</title>
  ...
  <form class="form-horizontal " name="search" method="post" action="" enctype="multipart/form-data">
    ...
    echo $msg;
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Search by Enquiry Number</label>
                    <div class="col-sm-10">
...
$sdata=$_POST['searchdata'];
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4> 
              <table class="table">
               ...
               <?php
$ret=mysqli_query($con,"select *from  tblenquiry where EnquiryNumber like '%$sdata%'");
