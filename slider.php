...
<html lang="zxx">
  <head>
      ...
      <title>Template / Vehicle detail </title>
  ...
  <body class="page">
    ...
    <!-- Loader end-->
        ...
        <div data-off-canvas="mobile-slidebar left overlay">
            <a class="navbar-brand scroll" href="home.html"><img class="scroll-logo" src="assets/media/general/logo-light.png" alt="logo"></a>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-auto col">
                                <div class="header-contacts d-none d-md-block d-lg-none d-xl-block"><i class="ic text-primary icon-call-in"></i><span class="header-contacts__inner">Call Us Today!<a class="header-contacts__number" href="tel:+919106620821">+91 910 662 0821</a></span></div>
            ...
            <div class="row">
              <div class="col-lg-8">
                ...
                <div class="b-goods-f__slider">
                  <div class="ui-slider-main js-slider-for"><img class="img-scale" src="assets/media/content/b-goods/main-slider/main/1.jpg" alt="foto"/><img class="img-scale" src="assets/media/content/b-goods/main-slider/main/2.jpg" alt="foto"/><img class="img-scale" src="assets/media/content/b-goods/main-slider/main/1.jpg" alt="foto"/><img class="img-scale" src="assets/media/content/b-goods/main-slider/main/2.jpg" alt="foto"/><img class="img-scale" src="assets/media/content/b-goods/main-slider/main/1.jpg" alt="foto"/></div>
                  <div class="ui-slider-nav js-slider-nav"><img class="img-scale" src="assets/media/content/b-goods/main-slider/thumb/1.jpg" alt="foto"/><img class="img-scale" src="assets/media/content/b-goods/main-slider/thumb/2.jpg" alt="foto"/><img class="img-scale" src="assets/media/content/b-goods/main-slider/thumb/3.jpg" alt="foto"/><img class="img-scale" src="assets/media/content/b-goods/main-slider/thumb/4.jpg" alt="foto"/><img class="img-scale" src="assets/media/content/b-goods/main-slider/thumb/5.jpg" alt="foto"/></div>
                </div>
